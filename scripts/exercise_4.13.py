...
class Model:
    ...
    def update(self) -> None:
        ...
        prey_loss = self.c * x_prev / (1 + self.a * x_prev) 

        self.x = x_prev + self.r * x_prev * (1 - x_prev / self.K) - predation_loss
        self.y = y_prev - self.d * y_prev + prey_loss * y_prev
...
class SimulationWindow:
    """Plots prey/predator trajectories with sliders for `r`, `b`, `K`, `c`, `a`, and `d`."""
    ...
    A_MIN, A_MAX, A_STEP = 0.0, 0.5, 0.0001
    ...
    def _update_plot(self) -> None:
        ...
        self.a_label.setText(f"a = {self.model.a:.4f} (predator growth saturation)")
